class GoodOlHUDStatusBar : BaseStatusBar
{
    ...
    protected void GOHDrawFullScreenStuff ()
    {
        ...
        let canshowberserk = CVar.FindCVar("goh_showberserk").GetBool() && (Powerup(CPlayer.mo.FindInventory("PowerStrength")) || Powerup(CPlayer.mo.FindInventory("PsxPowerStrength")));
