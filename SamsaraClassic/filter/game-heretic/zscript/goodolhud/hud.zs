class GoodOlHUDStatusBar : BaseStatusBar
{
    ...
    protected void GOHDrawFullScreenStuff ()
    {
        ...
        switch (GOHcolorscheme)
        {
          ...
          case -1:
            if (Wads.CheckNumForName("BLASPHEM", 0) != -1) { GOHcolorscheme = 5; }
            else { GOHcolorscheme = 3; }
            break;
        }
    ...
    protected virtual void GOHDrawPowerupTimers(int coordbasex, int coordbasey)
    {
        ...
        static const Name PowerupDefinitions[] =
        {
            ...
            "PowerWeaponLevel2",               "red",      "[RubyOre]", // different text color for heretic coexistence
            ...
            "PowerFlight",                     "yellow",   "[Yellow]",
            "PowerFlight2",                    "yellow",   "[Yellow]",
