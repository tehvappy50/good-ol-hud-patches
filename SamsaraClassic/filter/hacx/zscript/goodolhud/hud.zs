class GoodOlHUDStatusBar : BaseStatusBar
{
    ...
    {
        int maxammos = 36 * 3; // some of these are magazines or counters (charge/overheating/etc.)
        ...
        static const Name AmmoDefinitions[] = // have to use Name for switch/case and DECORATE purposes
        {
            ...
            // Hacx
            "HacxRounds",     "yellow",    "[Yellow]",
            "HacxCartridges", "red",       "[Red]",
            "HacxTorpedo",    "brown",     "[Brown]",
            "HacxMolecules",  "lightblue", "[LightBlue]",
            // Duke Nukem
