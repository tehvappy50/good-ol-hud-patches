class GoodOlHUDStatusBar : BaseStatusBar
{
    ...
    protected void GOHDrawFullScreenStuff ()
    {
        ...
        // HUD hiding
        if (CPlayer.mo.FindInventory("IntermissionModeItem") || CPlayer.mo.FindInventory("CutsceneModeItem") || CPlayer.mo.FindInventory("BondWatchToken"))
        {
        ...
        if ((armor && armor.Amount > 0) || hasquakepentagram)
        {
            ...
            if (canshowarmortype)
            {
                ...
                switch (armor.ArmorType)
                {
                  ...
                  case 'ArmorPack5ArmorQuake': armorcolor = "brown"; break;
    ...
    protected virtual void GOHDrawPowerupTimers(int coordbasex, int coordbasey)
    {
        ...
        static const Name PowerupDefinitions[] =
        {
            ...
            "PowerScanner",                          "purple",    "[Eggplant]", // different text color for square coexistence
    ...
    {
        int maxammos = 127 * 3; // some of these are magazines or counters (charge/overheating/etc.)
        ...
        for (int checkedammotypes = 1; checkedammotypes <= 4; checkedammotypes++)
        {
            ...
            {
              case 1:
                if (!ammotype1 && !ammo1goonadeshack && !alwaysshowammo1) { continue; }
              ...
              case 2:
                if ((!ammotype2 || ammotype2 == ammotype1) && !ammo2goonadeshack && !alwaysshowammo2) { continue; }
              ...
              case 3:
                if (!ammotype3 && !ammo3goonadeshack && !alwaysshowammo3) { continue; }
              ...
              case 4:
                if ((!ammotype4 || ammotype4 == ammotype3) && !ammo4goonadeshack && !alwaysshowammo4) { continue; }
